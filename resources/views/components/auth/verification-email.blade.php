                    ...
                    <div class="row flex-column-reverse flex-md-row">
                        <div class="col-md-12 ps-md-0">
                            <div class="auth-form-wrapper px-4 ps-5 py-5 pe-5">
                                ...
                                <form id="otp-form" action="{{ route('verification.store') }}" method="POST">
                                    @csrf
                                    @honeypot
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            otpForm.addEventListener("submit", function(e) {
                ...
                if (!otpInput.value.trim()) {
                    ...
                    Swal.fire({
                        icon: "warning",
                        title: "Kode OTP Belum Diisi",
                        text: "Silakan masukkan kode OTP terlebih dahulu sebelum verifikasi.",
                        timer: 2500,
                ...
                try {
                    ...
                    if (!data) {
                        Swal.fire({
                            ...
                            text: "Response server tidak valid (kemungkinan error 419/500)",
                        });
                    ...
                    Swal.fire({
                        ...
                        text: data.message || "Tidak ada pesan dari server.",
                        timer: 2500,
                        showConfirmButton: false,
                    });
                ...
                const timer = setInterval(() => {
                    ...
                    if (remaining <= 0) {
                        ...
                        Swal.fire({
                            icon: "info",
                            title: "Waktu Habis",
                            text: "Anda dapat mengirim ulang kode OTP sekarang.",
                            timer: 2000,
                            showConfirmButton: false,
                        });
                    }
